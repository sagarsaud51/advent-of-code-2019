...
public class Day2 {
  ...
  public static void main(String[] args) {
    ...
    for (a = 0; a < 99; a++) {
      for (b = 0; b < 99; b++) {
        ...
        day2 = new Day2();
        day2.repositionInputs(a, b);
        day2.gravityAssistProgram();

        if (day2.validateAnswer()) {
          flag = true;
          break;
        }
      }
      if (flag) {
        System.out.println(
            "The value in 0 index is " + day2.inputs[0] + " for noun " + a + " and verb " + b);
        break;
      }
    ...
    System.out.println("\n============================================"
        + "\n So the final result for 100 * noun + verb is : " + result
        + "\n============================================");
  }

  public boolean validateAnswer() {
    return inputs[0] == 19690720;
  }
  ...
  private void repositionInputs(int a, int b) {
    inputs[1] = a;
    inputs[2] = b;
  }
}
